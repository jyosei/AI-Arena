...
export default function Leaderboard() {
  ...
  const columns = [
    ...
    { title: metric, dataIndex: 'value', key: 'value', width: 100, align: 'right', render: (val)=> <Tooltip title={`当前指标：${metric}`}>{val}</Tooltip>, sorter: (a,b)=> {
    ...
    <div className="container" style={{ padding: '16px' }}>
      ...
      >
        <div style={{ marginBottom: 12, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Select size="middle" value={metric} onChange={(v) => setMetric(v)} style={{ minWidth: 200 }}>
