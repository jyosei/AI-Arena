    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_file', models.ImageField(blank=True, help_text='上传头像文件', null=True, upload_to='users/avatars/%Y/%m/%d/')),
                ('wechat_openid', models.CharField(blank=True, help_text='微信OpenID', max_length=128, null=True, unique=True)),
                ('wechat_unionid', models.CharField(blank=True, help_text='微信UnionID', max_length=128, null=True, unique=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user_a', 'updated_at'], name='users_priva_user_a__0e15e9_idx'),
        ),
        migrations.AddIndex(
            model_name='privatechatthread',
            index=models.Index(fields=['user_b', 'updated_at'], name='users_priva_user_b__1970ef_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['thread', 'created_at'], name='users_priva_thread__151077_idx'),
        ),
        migrations.AddIndex(
            model_name='privatemessage',
            index=models.Index(fields=['thread', 'is_read'], name='users_priva_thread__4e4460_idx'),
        ),
        migrations.AddIndex(
