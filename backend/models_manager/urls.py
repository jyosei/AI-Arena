...
from .views import GenerateImageView, GetImageStatusView,EvaluateDatasetView,DatasetListView, EvaluateDatasetStreamView, DatasetEvaluationListView, DatasetEvaluationDetailView # 导入新的 View
...
urlpatterns = [
    ...
    path('evaluate-dataset/stream/', EvaluateDatasetStreamView.as_view(), name='evaluate-dataset-stream'),
    path('dataset-evaluations/', DatasetEvaluationListView.as_view(), name='dataset-evaluation-list'),
